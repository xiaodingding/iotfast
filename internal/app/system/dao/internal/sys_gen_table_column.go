...
type SysGenTableColumnDao struct {
	...
	columns SysGenTableColumnColumns // columns contains all the column names of Table for convenient usage.
}

// SysGenTableColumnColumns defines and stores column names for table sys_gen_table_column.
type SysGenTableColumnColumns struct {
	ColumnId              string // 编号
...
//  sysGenTableColumnColumns holds the columns for table sys_gen_table_column.
var sysGenTableColumnColumns = SysGenTableColumnColumns{
	ColumnId:              "column_id",
	TableId:               "table_id",
...
// NewSysGenTableColumnDao creates and returns a new DAO object for table data access.
func NewSysGenTableColumnDao() *SysGenTableColumnDao {
	return &SysGenTableColumnDao{
		group:   "default",
		table:   "sys_gen_table_column",
		columns: sysGenTableColumnColumns,
	}
}

// DB retrieves and returns the underlying raw database management object of current DAO.
func (dao *SysGenTableColumnDao) DB() gdb.DB {
	return g.DB(dao.group)
}

// Table returns the table name of current dao.
func (dao *SysGenTableColumnDao) Table() string {
	return dao.table
}

// Columns returns all column names of current dao.
func (dao *SysGenTableColumnDao) Columns() SysGenTableColumnColumns {
	return dao.columns
}

// Group returns the configuration group name of database of current dao.
func (dao *SysGenTableColumnDao) Group() string {
	return dao.group
}

// Ctx creates and returns the Model for current DAO, It automatically sets the context for current operation.
func (dao *SysGenTableColumnDao) Ctx(ctx context.Context) *gdb.Model {
...
func (dao *SysGenTableColumnDao) Transaction(ctx context.Context, f func(ctx context.Context, tx *gdb.TX) error) (err error) {
