...
type DeviceCategoryDataSearchReq struct {
	g.Meta     `path:"/deviceCategoryData/list" tags:"设备类别数据" method:"get" summary:"设备类别数据列表"`
	CategoryId string  `p:"categoryId"` //数据类别主键
...
type DeviceCategoryDataGetReq struct {
	g.Meta `path:"/deviceCategoryData/get" tags:"设备类别数据" method:"get" summary:"获取设备类别数据数据"`
	Id     int `p:"id"`
}
...
type DeviceCategoryDataAddReq struct {
	g.Meta     `path:"/deviceCategoryData/add" tags:"设备类别数据" method:"post" summary:"添加设备类别数据"`
...
type DeviceCategoryDataEditReq struct {
	g.Meta     `path:"/deviceCategoryData/edit" tags:"设备类别数据" method:"put" summary:"修改设备类别数据"`
...
type DeviceCategoryDataDeleteReq struct {
	g.Meta `path:"/deviceCategoryData/delete" tags:"设备类别数据" method:"delete" summary:"删除设备类别数据"`
	Ids    []int `p:"ids"`
}
