...
export function listMqttTopicRecord(query:Object) {
  return request({
    url: '/api/v1/test/mqttTopicRecord/list',
    method: 'get',
    params: query
  })
}
...
export function getMqttTopicRecord(id:number) {
  return request({
    url: '/api/v1/test/mqttTopicRecord/get',
    method: 'get',
    params: {
     id: id.toString()
    }
...
export function addMqttTopicRecord(data:Object) {
  return request({
    url: '/api/v1/test/mqttTopicRecord/add',
    method: 'post',
    data: data
  })
}
...
export function updateMqttTopicRecord(data:Object) {
  return request({
    url: '/api/v1/test/mqttTopicRecord/edit',
    method: 'put',
    data: data
  })
}
...
export function delMqttTopicRecord(ids:number[]) {
  return request({
    url: '/api/v1/test/mqttTopicRecord/delete',
    method: 'delete',
    data:{
       ids:ids
    }
